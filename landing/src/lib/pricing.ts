...
export const CLOUD_NOTIFY_URL = "https://x.com/RheoAI";
...
export const PRICING_TIERS: PricingTier[] = [
	{
		...
		badge: "Available now",
		cta: {label: "Download Rheo", href: "/download"},
		features: [
	...
	},
	{
		...
		priceNote: "Launch price · free for $RHEO holders",
		highlighted: true,
		badge: "Coming soon",
...
export const CLOUD_FEATURES: CloudFeature[] = [
	...
	},
	{
		...
		body: "Voice profiles, generations, and captures — including the original audio Rheo keeps alongside each transcript — safe off your machine.",
	},
	{
	...
	},
	{
		...
		body: "Rheo works fully offline without an account. Cloud is an add-on for when you want backup and sync — never a requirement.",
	},
];
