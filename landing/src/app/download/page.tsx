            ...
            {triggered ? (
              <>
                ...
                <p className="text-lg text-muted-foreground">
                  {activeMeta
                    ? `Downloading Rheo for ${activeMeta.label} (${activeMeta.description}). Check your downloads folder.`
                    : 'Check your downloads folder for Rheo.'}
                </p>
              </>
            ) : (
              <>
                <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-foreground mb-4">
                  {linksError ? "We couldn't load the latest release." : 'Download Rheo'}
                </h1>
                <p className="text-lg text-muted-foreground">
                  {linksError
        ...
        <div className="mt-16 rounded-2xl border border-border bg-gradient-to-br from-card via-card/80 to-background backdrop-blur-sm p-8 md:p-10 overflow-hidden relative">
          ...
          <div className="relative">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-foreground mb-4">
              MasterZ1311 here — Rheo is built as an independent voice synthesis suite.
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-6 max-w-2xl">
              I build and maintain Rheo as a sovereign, private voice synthesis
              environment. It's completely free, open source, and runs entirely on your
              machine — no accounts, no telemetry, no cloud subscriptions. If it saves you an
              external API bill or powers your workflow, backing the project helps me keep
              shipping new models, performance upgrades, and architectural enhancements.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Get familiar with Rheo — local setup, voice cloning, and the REST API.
              </p>
            </a>
            <a
            ...
            >
              ...
              <h3 className="text-sm font-medium text-foreground mb-1">Community Discussions</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Ask questions, share workflows, and discuss with the community.
              </p>
            </a>
            <a
              href={GITHUB_REPO}
            ...
            >
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Explore the source, file issues, and track releases.
              </p>
            </a>
          </div>
        </div>
