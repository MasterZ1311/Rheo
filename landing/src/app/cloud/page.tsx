...
export const metadata: Metadata = {
	title: "Cloud Backup & Sync — Rheo",
	description:
		"End-to-end encrypted backup and sync for your Rheo library. We can't read your data — only your devices can. Optional, local-first, free for $RHEO holders.",
	openGraph: {
		title: "Rheo Cloud — encrypted backup & sync",
		description:
				...
				<div className="mx-auto max-w-3xl px-6">
					<div className="rounded-2xl border-2 border-accent/40 bg-card/60 backdrop-blur-sm p-8 md:p-10 text-center shadow-[0_8px_40px_hsl(43_60%_50%/0.08)]">
						...
						<p className="text-muted-foreground leading-relaxed max-w-2xl mx-auto">
							Rheo is local-first and privacy-first. The cloud keeps that
