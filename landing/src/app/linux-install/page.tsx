...
export const metadata: Metadata = {
  title: 'Linux Install - Rheo',
  description: 'Build Rheo from source on Linux. Clone, setup, and build in three commands.',
};
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="rounded-lg border border-border bg-card/60 p-4 font-mono text-sm">
                  ...
                  <div>git clone https://github.com/MasterZ1311/Rheo.git</div>
                  <div>cd Rheo</div>
                </div>
