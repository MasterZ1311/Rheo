...
export const metadata: Metadata = {
	title: `${TOKEN_TICKER} — The official Rheo token`,
	description: `${TOKEN_TICKER} is the official community token for Rheo on Solana. Entirely optional — Rheo is, and always will be, free and open source.`,
	openGraph: {
...
const USE_OF_FUNDS = [
	{
		...
		body: "The token is the equivalent of a salary — it lets me work on Rheo every day instead of squeezing it around other work.",
	},
	{
		icon: Cloud,
	...
	},
	{
		...
		body: "Adding TTS engines and broadening GPU / OS support so Rheo runs great on whatever you've got.",
	},
];

const FAQ = [
	{
		q: "Do I need the token to use Rheo?",
		a: "No. Rheo is free and open source, and every feature works without ever touching the token. It exists purely for supporters who want to back the project and have some fun.",
	},
	{
		q: "Is this an investment?",
		a: "No. $RHEO is a community token, not a security or a promise of returns. There is no roadmap of financial milestones, and nothing here is financial advice. Only spend what you're comfortable with.",
	},
	{
		q: "How do I buy it?",
	...
	},
	{
		...
		a: "Yes — going full-time on Rheo is funded by the token, alongside donations. The surest way to support the project either way is to use it, star the repo, and tell people about it.",
	},
];
					...
					<div className="mx-auto max-w-3xl px-6">
						<div className="text-center mb-12">
							...
							<p className="text-muted-foreground max-w-2xl mx-auto mt-4">
								Rheo grew to over a million downloads with zero marketing —
					...
					<div className="mx-auto max-w-3xl px-6">
						<div className="rounded-2xl border border-border bg-card/40 backdrop-blur-sm p-8">
							...
							<ul className="space-y-3">
								<ProofRow text={`${TOKEN_TICKER} is the only official Rheo token. The mint address on this page is the single source of truth — always verify it.`} />
