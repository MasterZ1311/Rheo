...
class PyTorchSTTBackend:
    ...
    async def transcribe(
        ...
        Args:
            ...
            task: Optional Whisper task ("transcribe" or "translate")
        ...
        def _transcribe_sync():
            ...
            # If language or translate task is provided, configure decoder prompt ids
            generate_kwargs = {}
            active_task = task or "transcribe"
            effective_lang = language if (language and language != "auto") else None
            if effective_lang or active_task == "translate":
