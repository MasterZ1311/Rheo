            ...
            try:
                ...
                try:
                    ...
                    if hasattr(tf_hub, "_is_offline_mode"):
                        ...
                        tf_hub.is_offline_mode = lambda: True
                ...
                if _saved_transformers_const is not None:
                    try:
                        ...
                        if hasattr(tf_hub, "_is_offline_mode"):
                            ...
                            tf_hub.is_offline_mode = _saved_transformers_const
                    except (ImportError, AttributeError):
                        pass
                _saved_env = None
...
def patch_transformers_mistral_regex():
    ...
    Rheo never loads Mistral models, so the rewrite the function would
...
if os.environ.get("RHEO_OFFLINE_PATCH", "1") != "0":
