...
def default_push_to_talk_chord() -> list[str]:
    """Return the default push-to-talk key chord list for the current operating system."""
...
def default_toggle_to_talk_chord() -> list[str]:
    """Return the default toggle-to-talk key chord list for the current operating system."""
    if sys.platform == "darwin":
