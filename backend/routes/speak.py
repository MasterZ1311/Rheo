"""POST /speak — REST wrapper around rheo.speak for non-MCP callers.
...
bindings (via X-Rheo-Client-Id) work identically.
"""
...
async def speak(
    ...
    """Speak text in a voice profile. Mirrors rheo.speak (MCP).
    ...
    if profile is None:
        ...
        raise HTTPException(
            ...
            detail=(
                ...
                "or configure a default in Rheo → Settings → MCP."
            ),
        )
