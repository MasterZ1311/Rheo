...
import { AlertCircle, ArrowUpRight, Book, Compass, Download, Loader2, MessageSquare, RefreshCw } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="text-xs text-muted-foreground">Rheo Docs</div>
          </div>
          <ArrowUpRight className="h-4 w-4 text-muted-foreground/40 group-hover:text-muted-foreground transition-colors" />
        </a>
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <div className="text-sm font-semibold text-foreground">GitHub Community</div>
            <div className="text-xs text-muted-foreground">Discussions & Support</div>
          </div>
          <ArrowUpRight className="h-4 w-4 text-muted-foreground/40 group-hover:text-muted-foreground transition-colors" />
        </a>
      </div>
