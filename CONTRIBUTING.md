...
Thank you for your interest in contributing to Rheo! This document provides guidelines and instructions for contributing.

## Code of Conduct

Please review our [Code of Conduct](.github/CODE_OF_CONDUCT.md) before participating in discussions or submitting contributions.
...
This builds the CPU sidecar (bundled with the app), the CUDA binary (placed in `%APPDATA%/sh.rheo.app/backends/` for runtime GPU switching), and the installable Tauri app.
