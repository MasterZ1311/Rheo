...
//! Rheo itself" and short-circuit the synthetic-paste path. On
//! Windows, `bundle_id` holds the lowercased exe basename (`"rheo.exe"`)
...
mod win {
    ...
    /// (e.g. `"rheo.exe"`). This is the Windows analogue of macOS'
