---
title: "Rheo Documentation"
description: "Rheo is the open-source, local-first AI voice studio — a free alternative to ElevenLabs and WisprFlow, running entirely on your machine."
---

Rheo (derived from the Greek **ῥέω** / *rhéō*, meaning *"to flow"*) is the **open-source, local-first AI voice studio** — a sovereign alternative to ElevenLabs and WisprFlow in one app. Clone voices, generate speech across 7 TTS engines, dictate into any app with a global hotkey, compose multi-voice projects, and let any MCP-aware agent speak in a voice you own. Everything runs directly on your hardware.

![Rheo Logo](/logo/icon-dark.png)
...
- **Agents speak back** — any MCP-aware agent can call Rheo to speak in one of your cloned voices
...
[View all releases](https://github.com/MasterZ1311/Rheo/releases/latest)

## Get Started

- [Installation](/overview/installation) — download and install Rheo
