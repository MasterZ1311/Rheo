---
title: "Installation"
description: "Download and install Rheo on macOS, Windows, or Linux"
---

## Download

Rheo is available for macOS and Windows, with Linux builds coming soon.
...
<Tabs items={["Apple Silicon", "Intel"]}>
  <Tab value="Apple Silicon">
    Download: [rheo_aarch64.app.tar.gz](https://github.com/MasterZ1311/Rheo/releases/latest/download/rheo_aarch64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf rheo_aarch64.app.tar.gz

    # Move to Applications
    mv Rheo.app /Applications/
    ```
  </Tab>
  <Tab value="Intel">
    Download: [rheo_x64.app.tar.gz](https://github.com/MasterZ1311/Rheo/releases/latest/download/rheo_x64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf rheo_x64.app.tar.gz
...
<Tabs items={["MSI Installer", "Setup Executable"]}>
  <Tab value="MSI Installer">
    Download: [rheo_x64_en-US.msi](https://github.com/MasterZ1311/Rheo/releases/latest/download/rheo_x64_en-US.msi)

    Double-click the MSI file and follow the installation wizard.
  </Tab>
  <Tab value="Setup Executable">
    Download: [rheo_x64-setup.exe](https://github.com/MasterZ1311/Rheo/releases/latest/download/rheo_x64-setup.exe)
...
When you launch Rheo for the first time:
...
2. **Data Directory** — Voice profiles and generated audio are stored in:
   - macOS: `~/Library/Application Support/sh.rheo.app/`
   - Windows: `%APPDATA%/sh.rheo.app/`
   - Linux: `~/.config/sh.rheo.app/`
