...
Rheo keeps a complete history of all generated audio, making it easy to find, reuse, and manage your creations.
...
- **macOS**: `~/Library/Application Support/sh.rheo.app/data/`
- **Windows**: `%APPDATA%/sh.rheo.app/data/`
- **Linux**: `~/.config/sh.rheo.app/data/`
