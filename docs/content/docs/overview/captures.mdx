...
how Rheo strips Whisper loop hallucinations *before* the LLM sees the
...
The original audio is kept alongside the transcript in your Rheo data
...
[Remote Mode](/overview/remote-mode) for running Rheo as a server the rest
