...
description: "A map of the three places you can record and transcribe audio in Rheo — dictation, captures, and voice-profile samples."
---

## Overview

Rheo records and transcribes audio in three different contexts, each
...
| Record a thought, a meeting, or a voice memo inside Rheo | Captures tab | [Captures](/overview/captures) |
...
The transcript lands in whatever text field you had focused,
...
<Callout type="info">
  ...
  hard inputs — most famously the "thanks for watching" loop. Rheo
