---
title: "Architecture"
description: "Understanding Rheo's technical architecture"
---

## System Overview

Rheo uses a client-server architecture with a React frontend and Python backend. The desktop app is built with Tauri and contains two main layers:
...
See [TTS Engines](/developer/tts-engines) for the full contract and integration phases, and [PROJECT_STATUS.md](https://github.com/MasterZ1311/Rheo/blob/MZ-Main/docs/PROJECT_STATUS.md) for candidates under evaluation.
