...
See [TTS Engines](/developer/tts-engines) for the full contract and integration phases, and [PROJECT_STATUS.md](https://github.com/MasterZ1311/Rheo/blob/main/docs/PROJECT_STATUS.md) for candidates under evaluation.
