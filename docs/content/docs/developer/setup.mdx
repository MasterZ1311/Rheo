...
description: "Set up your local development environment for Rheo"
---
...
| `just build-server-cuda` | **Windows:** CUDA server binary only, placed in `%APPDATA%/sh.rheo.app/backends/cuda` for local testing |
