...
4. **Checked [`docs/PROJECT_STATUS.md`](https://github.com/MasterZ1311/Rheo/blob/main/docs/PROJECT_STATUS.md)** — the living engineering roadmap that tracks prioritized tasks (Tier 1 → 3), architectural bottlenecks, and candidate TTS engines under evaluation (including why some are backlogged)
...
- Check [`docs/PROJECT_STATUS.md`](https://github.com/MasterZ1311/Rheo/blob/main/docs/PROJECT_STATUS.md) and the [roadmap](https://github.com/MasterZ1311/Rheo#roadmap) before proposing work — the status doc lists prioritized tasks (Tier 1 → 3), known architectural bottlenecks, and candidate TTS engines already under evaluation (including why some have been backlogged)
...
2. Read [`docs/PROJECT_STATUS.md`](https://github.com/MasterZ1311/Rheo/blob/main/docs/PROJECT_STATUS.md) for current engineering priorities
3. Search [existing issues](https://github.com/MasterZ1311/Rheo/issues)
4. Open a new issue or discussion
5. See [CONTRIBUTING.md](https://github.com/MasterZ1311/Rheo/blob/main/CONTRIBUTING.md) in the repo
