...
description: "Rheo documentation development guide"
---

This directory contains the documentation for Rheo, built with [Fumadocs](https://fumadocs.dev).
...
- `content/docs/developer/` — architecture, backend internals, and developer guides
